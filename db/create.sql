...
CREATE TABLE tci05_cita (id_cita SERIAL NOT NULL, fk_id_persona int4 NOT NULL, fk_id_servicio int4 NOT NULL, fk_id_lista_precio int4 NOT NULL, fk_id_sucursal int4 NOT NULL, fk_id_empleado int4 NOT NULL, fh_cita timestamp, PRIMARY KEY (id_cita));
